...
import ServicesIllustration from "../assets/illustrations/services.svg?react";
    ...
    <div className={`${styles.page} motion-fade-in`}>
      <div className={`${styles.container} motion-fade-up`} style={{ position: 'relative', overflow: 'hidden', '--dur-base': '420ms', '--easing-soft': 'var(--easing-deluxe)' }}>
        ...
        <section className={`${styles.hero} motion-scale-in`}>
          <RotatingLanguages items={LANGUAGES} />
          <p className={`${styles.sub} motion-fade-up delay-1`} style={{ marginTop: '12px' }}>
            languages we offer
          </p>
        </section>
        ...
        >
          <blockquote className="motion-fade-up" style={{ justifySelf: 'end', color: 'var(--muted)', fontSize: '0.9rem', maxWidth: '22ch', lineHeight: 1.5, textAlign: 'right' }}>
            “Carefully authored lessons. Just the essentials.”
          </blockquote>
          <div
            style={{
              width: '100%',
          ...
          >
            <ServicesIllustration aria-label="Services illustration" style={{ width: '100%', height: 'auto', display: 'block' }} />
          </div>
